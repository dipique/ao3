...
import { options, READ_MARK, setMark, setMarkGroup } from '#common'
 ...
 *
 * Marks are written through these two functions and nothing else — there is
 ...
 *
 * Both are synchronous because the strictest caller is the one that can't await:
