import { app, css, loader } from 'virtual:site-bundle'

import type { SiteBundle } from './payload.ts'

/**
 * The app, loader and stylesheet an export carries, as the exporter sees them.
 *
 * One module, and a leaf, so everything else about building an export stays
 * plain data: {@link file://./payload.ts} takes these as an argument
 ...
 * as part of this build and injected here as data, because the exporter
 * runs in the options page and has no filesystem to read a bundle out of.
 */

export const siteBundle: SiteBundle = { app, loader, css }
